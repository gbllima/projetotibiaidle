...
export function App() {
  ...
  if (screen === 'boot') return <div className="auth-page"><div className="auth-page-bg" aria-hidden /><div className="auth-page-vignette" aria-hidden /><div className="splash auth-card-enter"><h1>TIBIA <span>IDLE</span></h1>
